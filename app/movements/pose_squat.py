...
def squat(patient_mrn, patient_name, exercise_type, max_range_of_motion, expected_count):
    ...
    meta_session_id = "POSESQUAT-" + str(uuid.uuid4())[:4] + "-" + str(uuid.uuid4())[:4]
        ...
        while True:
            ...
            if elapsed_time < countdown:
                ...
                if len(lmList) != 0:
                    ...
                    if previous_angle is not None and knee != previous_angle:
                    ...
                    if form == 1:
                        if per == 0:
                            ...
                            if direction == 0 and knee <= 90 and shoulder > 160:
                                ...
                                count += 1
                                direction = 1
                                max_per = 0  # Reset the max percentage after a complete squat
                                movement_start_time = time.time()
                        elif per == 100:
                            feedback = "Now go DOWN"
                            feedback_color = (0, 0, 255)  # Red for DOWN
                            if direction == 1 and shoulder > 160 and knee > 160:
                                direction = 0
